...
/** KAOSResolution class
    A KAOS resolution relationship
**/
class KAOSResolution extends KAOSRelationship {
    /** constructor
    ...
    **/
    constructor(uuid, idnum) {
        super(uuid, idnum);
        this._idname = "Resolution";
        this._identifier = "R" + idnum;
        this._reference =  this._idname.toLowerCase() + "_" + uuid;
        this._definition = "Target obstacle can be resolved when the attached goal is satisfied.";
        this._constraints = [
